...
var vegetables = ['carrot', 'onion', 'leek', 'tomato', 'squash'];
...
// different fruits.
var fruits = ['grape', 'mango', 'apple', 'peach', 'banana', 'strawberry', 'pineapple'];
...
groceryStore.location = 'Detroit, Michigan';
